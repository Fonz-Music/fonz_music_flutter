class SpotifyReccomendations {
  List<Tracks> _tracks;
  List<Seeds> _seeds;

  SpotifyReccomendations({List<Tracks> tracks, List<Seeds> seeds}) {
    this._tracks = tracks;
    this._seeds = seeds;
  }
  ...
  SpotifyReccomendations.fromJson(Map<String, dynamic> json) {
    if (json['tracks'] != null) {
...
class Tracks {
  ...
  LinkedFrom get linkedFrom => _linkedFrom;
  set linkedFrom(LinkedFrom linkedFrom) => _linkedFrom = linkedFrom;
  ...
  Tracks.fromJson(Map<String, dynamic> json) {
    ...
    _type = json['type'];
    _uri = json['uri'];
    _linkedFrom = json['linked_from'] != null
  ...
  Map<String, dynamic> toJson() {
    ...
    data['uri'] = this._uri;
    if (this._linkedFrom != null) {
      data['linked_from'] = this._linkedFrom.toJson();
    }
    return data;
  }
}
...
class Seeds {
  ...
  int get initialPoolSize => _initialPoolSize;
  set initialPoolSize(int initialPoolSize) =>
      _initialPoolSize = initialPoolSize;
  int get afterFilteringSize => _afterFilteringSize;
  set afterFilteringSize(int afterFilteringSize) =>
      _afterFilteringSize = afterFilteringSize;
  int get afterRelinkingSize => _afterRelinkingSize;
  set afterRelinkingSize(int afterRelinkingSize) =>
      _afterRelinkingSize = afterRelinkingSize;
  String get id => _id;
  set id(String id) => _id = id;
  String get type => _type;
  set type(String type) => _type = type;
  ...
  Seeds.fromJson(Map<String, dynamic> json) {
    _initialPoolSize = json['initialPoolSize'];
    _afterFilteringSize = json['afterFilteringSize'];
    _afterRelinkingSize = json['afterRelinkingSize'];
    _id = json['id'];
    _type = json['type'];
    _href = json['href'];
  }
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['initialPoolSize'] = this._initialPoolSize;
    data['afterFilteringSize'] = this._afterFilteringSize;
    data['afterRelinkingSize'] = this._afterRelinkingSize;
    data['id'] = this._id;
    data['type'] = this._type;
    data['href'] = this._href;
    return data;
