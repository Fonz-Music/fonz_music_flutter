...
class UserTopTracksResponse {
  ...
  UserTopTracksResponse.fromJson(Map<String, dynamic> json) {
    if (json['items'] != null) {
...
class TrackResultRow extends StatelessWidget {
  Items result;
  Function onTap;

  TrackResultRow(Items result, Function onTap) {
    this.result = result;
    this.onTap = onTap;
  }
  ...
  Widget build(BuildContext context) {
    return ListTile(
      leading: Image.network(result.album.images.last.url),
