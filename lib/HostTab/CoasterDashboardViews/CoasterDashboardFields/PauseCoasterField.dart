...
class PauseCoasterField extends StatefulWidget {
  ...
  @override
  _PauseCoasterFieldState createState() => _PauseCoasterFieldState();
}

class _PauseCoasterFieldState extends State<PauseCoasterField> {
    ...
    return SimpleDialog(
        ...
        children: [
          Container(
            ...
            padding: const EdgeInsets.fromLTRB(10, 10, 10, 10),
            child: Text(
              'are you sure you wanna ${(widget.active)
                  ? "pause"
                  : "unpause"} your coaster?',
              style: TextStyle(
                fontFamily: FONZFONTONE,
                fontSize: HEADINGFIVE,
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FlatButton(
                      ...
                      onPressed: () async{
                        log("issue first ");
                        await CoasterManagementApi.pauseCoaster(widget.coasterUid, !widget.active);
